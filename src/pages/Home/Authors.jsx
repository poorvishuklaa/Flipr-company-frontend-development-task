...
import logo2 from '../../assets/Client-First - Images/logo2.svg';
import logo3 from '../../assets/Client-First - Images/logo3.svg';
import logo4 from '../../assets/Client-First - Images/logo4.svg';
import logo5 from '../../assets/Client-First - Images/logo5.svg';
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
        {authors.map((author, index) => (
          <div key={index} className="bg-gray-100 rounded-lg p-8 text-center transition-colors duration-300 hover:bg-yellow-50">
            <a href="/AuthorsAbout" target="_blank" rel="noopener noreferrer">
